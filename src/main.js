...
const routes = [
  ...
  { path: '/data-structures', component: ResourcesLesson, props: { tutorialId: 'dataStructures' } },
  // Lessons - Basics
  ...
  { path: '/blog', component: ResourcesLesson, props: { tutorialId: 'blog' } },
  // Lessons - MFS
  ...
  { path: '/mutable-file-system', component: ResourcesLesson, props: { tutorialId: 'mutableFileSystem' } },
  // 404
  { path: '*', name: '404' }
]
