...
import T0006L02 from './tutorials/0006/02.vue'
import T0006L03 from './tutorials/0006/03.vue'
import T0006L04 from './tutorials/0006/04.vue'
import T0006L05 from './tutorials/0006/05.vue'
import T0006L06 from './tutorials/0006/06.vue'
...
const routes = [
  ...
  { path: '/data-structures/01', component: T0001L01, props: { tutorialId: '0001' } },
  { path: '/data-structures/02', component: T0001L02, props: { tutorialId: '0001' } },
  { path: '/data-structures/03', component: T0001L03, props: { tutorialId: '0001' } },
  { path: '/data-structures/04', component: T0001L04, props: { tutorialId: '0001' } },
  { path: '/data-structures/05', component: T0001L05, props: { tutorialId: '0001' } },
  // Tutorial 0002
  { path: '/basics', component: Landing, props: { tutorialId: '0002' } },
  { path: '/basics/resources', component: ResourcesLesson, props: { tutorialId: '0002' } },
  { path: '/basics/01', component: T0002L01, props: { tutorialId: '0002' } },
  { path: '/basics/02', component: T0002L02, props: { tutorialId: '0002' } },
  { path: '/basics/03', component: T0002L03, props: { tutorialId: '0002' } },
  // Tutorial 0003
  { path: '/blog', component: Landing, props: { tutorialId: '0003' } },
  { path: '/blog/resources', component: ResourcesLesson, props: { tutorialId: '0003' } },
  { path: '/blog/01', component: T0003L01, props: { tutorialId: '0003' } },
  { path: '/blog/02', component: T0003L02, props: { tutorialId: '0003' } },
  { path: '/blog/03', component: T0003L03, props: { tutorialId: '0003' } },
  { path: '/blog/04', component: T0003L04, props: { tutorialId: '0003' } },
  { path: '/blog/05', component: T0003L05, props: { tutorialId: '0003' } },
  { path: '/blog/06', component: T0003L06, props: { tutorialId: '0003' } },
  { path: '/blog/07', component: T0003L07, props: { tutorialId: '0003' } },
  // Tutorial 0004
  ...
  { path: '/mutable-file-system/01', component: T0004L01, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/02', component: T0004L02, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/03', component: T0004L03, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/04', component: T0004L04, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/05', component: T0004L05, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/06', component: T0004L06, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/07', component: T0004L07, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/08', component: T0004L08, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/09', component: T0004L09, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/10', component: T0004L10, props: { tutorialId: '0004' } },
  { path: '/mutable-file-system/11', component: T0004L11, props: { tutorialId: '0004' } },
  // Tutorial 0005
  ...
  { path: '/regular-files-api/01', component: T0005L01, props: { tutorialId: '0005' } },
  { path: '/regular-files-api/02', component: T0005L02, props: { tutorialId: '0005' } },
  { path: '/regular-files-api/03', component: T0005L03, props: { tutorialId: '0005' } },
  { path: '/regular-files-api/04', component: T0005L04, props: { tutorialId: '0005' } },
  { path: '/regular-files-api/05', component: T0005L05, props: { tutorialId: '0005' } },
  ...
  { path: '/anatomy-of-a-cid/02', component: T0006L02, props: { tutorialId: '0006' } },
  { path: '/anatomy-of-a-cid/03', component: T0006L03, props: { tutorialId: '0006' } },
  { path: '/anatomy-of-a-cid/04', component: T0006L04, props: { tutorialId: '0006' } },
  { path: '/anatomy-of-a-cid/05', component: T0006L05, props: { tutorialId: '0006' } },
  { path: '/anatomy-of-a-cid/06', component: T0006L06, props: { tutorialId: '0006' } },
  // 404
