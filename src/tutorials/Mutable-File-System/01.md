...
If you haven't yet done so, we encourage you to check out our [Decentralized Data Structures tutorial](https://proto.school/#/data-structures/), where you can learn all about the decentralized web and how it compares to the web you're accustomed to. There you'll learn all about content addressing, [cryptographic hashing](https://en.wikipedia.org/wiki/Cryptographic_hash_function), [Content Identifiers](https://docs.ipfs.io/guides/concepts/cid/) (CIDs), and sharing with peers, all of which you'll need to understand to make the most of this tutorial on IPFS.
