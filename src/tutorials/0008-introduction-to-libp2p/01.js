...
const choices = [
  ...
  {
    answer: "`libp2p` started as a component of `IPFS`, but eventually grew out of `IPFS` into its own independent project. `IPFS` continues to be one of the main users of `libp2p`.",
    correct: true,
