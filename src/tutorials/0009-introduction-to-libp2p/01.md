...
Before, we knew the location of our libp2p logo image, but, if instead we know it's [CID](https://proto.school/anatomy-of-a-cid) (Content IDentifier) we can then ask who has the image with this CID.
