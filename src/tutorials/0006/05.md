...
The second one starts with `bafy...`. The first character `b` is the base encoding prefix indentifier for most implementations of IPFS, which by default encode the CIDs using `base32`.
