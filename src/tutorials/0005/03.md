...
The value of the `hash` is a `CID` (Content Identifier), a unique address generated from the content of the node. (For a more in-depth look at how `CID`s are generated and why they're important, check out our [Decentralized data structures](https://proto.school/#/data-structures) tutorial.) In a future lesson, we will learn how to use this value to retrieve the contents of a file.
