<template>
  <h2 class="mt0 mb2 green fw4 fill-current">
    ...
    <div v-if="!isMultipleChoiceLesson" class="fr">
      <button v-if="expandExercise" @click="toggleExpandExercise" title="Shrink exercise box" class="b--transparent bg-transparent green hover-green-muted pointer focus-outline">
      ...
      <button v-else @click="toggleExpandExercise" title="Expand exercise box" class="b--transparent bg-transparent charcoal-muted hover-green pointer focus-outline">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
          <path d="M16 4 L28 4 L28 16 L24 12 L20 16 L16 12 L20 8z M4 16 L8 20 L12 16 L16 20 L12 24 L16 28 L4 28z" />
        </svg>
      </button>
