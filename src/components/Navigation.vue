<template>
  <nav class="bg-aqua">
    ...
    <div class="dn db-ns center mw7 pv3 ph3">
      ...
      <div v-if="isLesson && notFound !== true" class="link-list flex overflow-auto items-center bg-aqua navy f5 fw6 center tc mw7">
    ...
    <div class="db dn-ns">
      <div class="flex items-center bg-aqua ph3 pv3 w-100">
        <!-- If in lesson (breadcrumbs) -->
        <div v-if="isLesson && notFound !== true" class="flex-auto link fw5 f5 db bb border-aqua navy">
          <router-link class="nav-link navy" to="/tutorials">Tutorials</router-link>
          <span class="fw4"> > </span>
